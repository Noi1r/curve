# Generalised MNT curves with k = 3, 4, 6 (non-prime order)
...
class MNTG(EllipticCurve_finite_field):
    ...
    def __init__(self, k, u, D, c, d, a, b):
        ...
        - `u` is the seed such that:
              t = u+1          (the trace)
              r = Phi_k(u)/d   (the curve has a subgroup of prime order r and embedding degree k)
        ...
        # no beta, lambda because the CM by sqrt(-D) is not trivial
