...
test_vector_bn =[
    ...
    {'u':-(2**94+2**78+2**67+2**64+2**48+1),'b':2, 'pnbits': 382,  'rnbits':382, 'cost_S':123, 'deg_h_S':6, 'label':"Aranha et al eprint 2021/1029"},
    {'u':       2**94+2**81+2**74+2**66, 'b':  14, 'pnbits': 382,  'rnbits':382, 'cost_S':123, 'deg_h_S':6, 'label':"Mina Testnet BN Hybrid cycle Izaak Meckler https://github.com/o1-labs/zexe/tree/master/algebra/src/bn_382"},
...
test_vector_bls24 = [
    {'u': 0xeec0,   'b':-2, 'pnbits':158, 'rnbits':128, 'cost_S':131, 'deg_h_S':24, 'cost_C':124, 'deg_h_C':6, 'label':"+2^16-2^12-2^8-2^6 Hw2naf 4"},
    {'u':-0xfe03,   'b': 1, 'pnbits':159, 'rnbits':128, 'cost_S':131, 'deg_h_S':24, 'cost_C':124, 'deg_h_C':6, 'label':"-2^16+2^9-2^2+1 Hw2naf 4"},
    {'u':-0xfe60,   'b':-3, 'pnbits':159, 'rnbits':128, 'cost_S':131, 'deg_h_S':24, 'cost_C':124, 'deg_h_C':6, 'label':"-2^16+2^9-2^7+2^5 Hw2naf 4"},
    {'u': 0x9c004,  'b': 4, 'pnbits':192, 'rnbits':155, 'cost_S':141, 'deg_h_S':24, 'cost_C':134, 'deg_h_C':6, 'label':"+2^19+2^17-2^14+2^2 Hw2naf 4"},
    {'u': 0xffff7,  'b': 1, 'pnbits':199, 'rnbits':160, 'cost_S':144, 'deg_h_S':24, 'cost_C':136, 'deg_h_C':6, 'label':"+2^20-2^3-1 Hw2naf 3"},
    {'u':-0xedfe00, 'b': 4, 'pnbits':238, 'rnbits':192, 'cost_S':148, 'deg_h_S':24, 'cost_C':147, 'deg_h_C':6, 'label':"-2^24+2^20+2^17+2^9 Hw2naf 4"},
    {'u': 0xffebfc, 'b':-3, 'pnbits':239, 'rnbits':192, 'cost_S':148, 'deg_h_S':24, 'cost_C':147, 'deg_h_C':6, 'label':"+2^24-2^12-2^10-2^2 Hw2naf 4"},
    ...
    {'u': 2**32-2**29-2**27+2**24+2**16+2**15  ,'b':4,'pnbits':317, 'rnbits':255, 'cost_S':160, 'deg_h_S':24, 'label':"El Housni Feb 2022, 2^32-2^29-2^27+2^24+2^16+2^15"},#12
    ...
    {'u':-2**32+2**28-2**23+2**21+2**18+2**12-1,'b':1,'pnbits':318,'rnbits':256,'cost_S':161,'deg_h_S':24,'label':"July 23, 2019, in paper, -2^32+2^28-2^23+2^21+2^18+2^12-1"},#20
    ...
    {'u': 2**32-2**28+2**26-2**21+2**16-2**10-1,'b':1,'pnbits':318,'rnbits':256,'cost_S':161,'deg_h_S':24,'label':"July 23, 2019, 2^32-2^28+2^26-2^21+2^16-2^10-1"},#27
    #
    {'u': -2**32+2**28+2**12,'b':5,'pnbits':318,'rnbits':256,'cost_S':161,'deg_h_S':24,'label':"-2^32+2^28+2^12 Barbulescu-El Mrabet-Ghammam 2019/485 Tab.8"},#28
    #
    {'u':-2**48+2**45+2**31-2**7,    'b': 4, 'pnbits': 477, 'rnbits': 383, 'cost_S':188.6, 'deg_h_S':24, 'label':"Aranha et al Pairing 2012 eprint 2012/232"},#29
    # for chained SNARK, by increasing 2-NAF Hamming weight and decreasing 2-valuation on r-1 and p-1
    # the best ones for highest possible 2-valuation are 2^38 | u-1 and 2^37 | u-1
    {'u': 0x50dc000000001, 'b': 1, 'pnbits':502,'rnbits':403, 'val':2, 'valp':38, 'valr':40, 'deg_h_S':24,'cost_S':193, 'label':"u=+2^50+2^48+2^44-2^41-2^38+1        Hw2NAF=6"},#30
    {'u': 0x811e000000001, 'b': 1, 'pnbits':509,'rnbits':409, 'val':2, 'valp':37, 'valr':39, 'deg_h_S':24,'cost_S':193, 'label':"u=+2^51+2^44+2^41-2^37+1             Hw2NAF=5"},#31
    # other seeds with high 2-valuation, 2^36 | u-1
    {'u': 0x575d000000001, 'b': 1, 'pnbits':503,'rnbits':404, 'val':2, 'valp':36, 'valr':38, 'deg_h_S':24,'cost_S':193, 'label':"u=+2^51-2^49-2^47-2^43-2^41-2^38+2^36+1 Hw2NAF=8"},
    {'u':-0x8a14fffffffff, 'b': 1, 'pnbits':510,'rnbits':409, 'val':2, 'valp':36, 'valr':38, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^51-2^47-2^45-2^40-2^38-2^36+1      Hw2NAF=7"},
    {'u':-0x8e4cfffffffff, 'b': 1, 'pnbits':510,'rnbits':410, 'val':2, 'valp':36, 'valr':38, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^51-2^48+2^45-2^42-2^40+2^38-2^36+1 Hw2NAF=8"},
    {'u':-0x9584fffffffff, 'b': 1, 'pnbits':511,'rnbits':410, 'val':2, 'valp':36, 'valr':38, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^51-2^49+2^47+2^45+2^43-2^38-2^36+1 Hw2NAF=8"},
    # other seeds with high 2-valuation, 2^35 | u-1
    {'u':-0x4b677ffffffff, 'b': 1, 'pnbits':501,'rnbits':402, 'val':2, 'valp':35, 'valr':37, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^50-2^48+2^46+2^43+2^41-2^39+2^35+1 Hw2NAF=8"},
    {'u':-0x5eff7ffffffff, 'b': 1, 'pnbits':505,'rnbits':405, 'val':2, 'valp':35, 'valr':37, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^51+2^49+2^44+2^35+1                Hw2NAF=5"},
    {'u': 0x60a0800000001, 'b': 1, 'pnbits':505,'rnbits':405, 'val':2, 'valp':35, 'valr':37, 'deg_h_S':24,'cost_S':193, 'label':"u=+2^51-2^49+2^43+2^41+2^35+1           Hw2NAF=6"},
    {'u': 0x78d0800000001, 'b': 1, 'pnbits':508,'rnbits':408, 'val':2, 'valp':35, 'valr':37, 'deg_h_S':24,'cost_S':193, 'label':"u=+2^51-2^47+2^44-2^42+2^40+2^35+1      Hw2NAF=7"},
    {'u':-0x84ee7ffffffff, 'b': 1, 'pnbits':509,'rnbits':409, 'val':2, 'valp':35, 'valr':37, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^51-2^46-2^44+2^40+2^37-2^35+1      Hw2NAF=7"},
    # other sparse seeds Hw2-naf <= 6 and 2^34 | u-1, 2^32 | u-1
    {'u': 0x4809c00000001, 'b': 1, 'pnbits':501,'rnbits':402, 'val':2, 'valp':34, 'valr':36, 'deg_h_S':24,'cost_S':193, 'label':"u=+2^50+2^47+2^39+2^37-2^34+1        Hw2NAF=6"},
    {'u':-0x981feffffffff, 'b': 1, 'pnbits':511,'rnbits':410, 'val':2, 'valp':32, 'valr':34, 'deg_h_S':24,'cost_S':193, 'label':"u=-2^51-2^49+2^47-2^41+2^32+1        Hw2NAF=6"},
    #
    {'u':-1+2**11-2**28-2**51,       'b': 1, 'pnbits': 509, 'rnbits': 409, 'cost_S':193.0, 'deg_h_S':24, 'label':"CostelloLauterNaehrig Indocrypt 2011 eprint 2011/465"},#43
    ...
    {'u':-2**4-2**6-2**8-2**51,      'b': 4, 'pnbits': 509, 'rnbits': 409, 'cost_S':193.0, 'deg_h_S':24, 'label':"CostelloLauterNaehrig Indocrypt 2011 eprint 2011/465"},#46
    ...
    {'u':-2**56-2**43+2**9-2**6,     'b':-2, 'pnbits': 559, 'rnbits': 449, 'cost_S':201.0, 'deg_h_S':24, 'label':"Barbulescu-Duquesne JoC 18"},#49
    ...
    {'u':-2**103-2**101+2**68+2**50, 'b':-2, 'pnbits':1032, 'rnbits': 827, 'cost_S':265.0, 'deg_h_S':24, 'label':"Barbulescu-Duquesne JoC 18"},#52
    #
    ...
    {'u':0x1ffffffff801ffffffffffffffff, 'b':1, 'pnbits':1089, 'rnbits':872, 'cost_S':None, 'deg_h_S':None, 'cost_C':None, 'deg_h_C':None, 'label':"2^109-2^75+2^65-1 Hw2naf 4 ACNS'17 KIKYTK Tab 6 DOI 10.1007/978-3-319-61204-1_4"},
]
...
test_vector_bls42 = [
    {'u':0x7ffffffff03, 'b':1, 'pnbits':687, 'rnbits':516, 'cost_S':None, 'deg_h_S':None, 'cost_C':None, 'deg_h_C':None, 'label':"2^43-2^8+2^2-1 Hw2naf 4 ACNS'17 KIKYTK Tab 6 DOI 10.1007/978-3-319-61204-1_4"},
]
...
test_vector_bls48 = [
    ...
    {'u':  0xfffbfbf0, 'b':4, 'pnbits':575, 'rnbits':512, 'cost_S':None, 'deg_h_S':None, 'cost_C':None, 'deg_h_C':None, 'label':"2^32-2^18-2^10-2^4 Hw2naf 4 BangAranhaFouotsa19 DOI 10.1504/IJACT.2020.107167"},
    {'u':-0x140000381, 'b':1, 'pnbits':581, 'rnbits':518, 'cost_S':None, 'deg_h_S':None, 'cost_C':None, 'deg_h_C':None, 'label':"-2^32-2^30-2^10+2^7-1 Hw2naf 5 ACNS'17 KIKYTK Tab 6 DOI 10.1007/978-3-319-61204-1_4"},
]
...
test_vector_kss32 = [
    ...
    {'u':0x1ffffc0042ffb, 'a':2, 'pnbits':861, 'rnbits':738, 'cost_S':None, 'deg_h_S':None, 'cost_C':None, 'deg_h_C':None, 'label':"2^49-2^30+2^18+2^14-2^12-2^2-1 Hw2naf 7 ACNS'17 KIKYTK Tab 6 DOI 10.1007/978-3-319-61204-1_4"},
]
...
test_vector_kss36 = [
    ...
    {'u':-0x3ffdefbffffffe0, 'b':2, 'pnbits':798, 'rnbits':669, 'cost_S':None, 'deg_h_S':None, 'cost_C':None, 'deg_h_C':None, 'label':"-2^58+2^45+2^40+2^34+2^5 Hw2naf 5 ACNS'17 KIKYTK Tab 6 DOI 10.1007/978-3-319-61204-1_4"},
]
...
test_vector_kss54 = [
    ...
    {'u': 0xc404042, 'b':-4, 'pnbits':569, 'rnbits':512, 'cost_S':None, 'deg_h_S':None, 'label':"eprint 2018/193 2^27+2^26+2^22+2^14+2^6+2 Hw 6, implemented in BangAranhaFouotsa19 DOI 10.1504/IJACT.2020.107167"},
]
