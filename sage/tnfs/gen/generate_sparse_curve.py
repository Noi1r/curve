...
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 27 -r 382 384 --2NAF --find_all_w_up_to -w 6
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 24 -r 256 256 --2NAF --find_all_w_up_to -w 6
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 21 -r 382 384 --2NAF --find_all_w_up_to -w 5
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 15 -p 928 928 -w 6
# inversion/conjugation is not free with odd embedding degree, it is better to avoid negative bits
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 15 -r 380 384 --find_all_w_up_to -w 5
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 15 -p 760 768 --find_all_w_up_to -w 5
# sage -python -m tnfs.gen.generate_sparse_curve --bls -k 15 -p 888 896 --find_all_w_up_to -w 5
...
#
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 16 -D 1 -choice_gg 1 -r 250 400 -w 6 --find_all_w_up_to --2NAF
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 18 -D 3 -choice_gg 1 -r 256 256 -w 6 --find_all_w_up_to --2NAF
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 20 -D 1 -r 378 384 -w 6 --find_all_w_up_to --2NAF
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 20 -D 1 -choice_gg 1 -r 378 384 -w 6 --find_all_w_up_to --2NAF
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 28 -D 1 -choice_gg 0 -r 378 384 -w 6 --find_all_w_up_to --2NAF
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 16 -D 1 -choice_gg 4 -r 370 384 -w 6 --find_all_w_up_to --2NAF
# sage -python -m tnfs.gen.generate_sparse_curve --gg -k 22 -D 7 -r 370 384 -w 6 --find_all_w_up_to --2NAF
#
...
# sage -python -m tnfs.gen.generate_sparse_curve --fm -code 21 -r 380 384 -w 6 --find_all_w_up_to
# sage -python -m tnfs.gen.generate_sparse_curve --fm -code 22 -r 380 384 -w 6 --find_all_w_up_to
# sage -python -m tnfs.gen.generate_sparse_curve --fm -code 221 -r 380 384 -w 6 --find_all_w_up_to
# sage -python -m tnfs.gen.generate_sparse_curve --fm -code 222 -r 380 384 -w 6 --find_all_w_up_to
...
# sage -python -m tnfs.gen.generate_sparse_curve --fst66 -k 20 -r 384 384 -w 5 --find_all_w_up_to --2NAF
...
curve = None # KSS or GG or BLS or BN or Aurifeuillean or FotiadisMartindale or FST62, FST63, FST64, FST66, FST67, or Cyclotomic
k = None
allowed_k = None
...
print("usage: sage -python -m tnfs.gen.{} [--kss | --gg | --bls | --bn | --auri | --fm | --fst62 | --fst63 | --fst64 | --fst66 | --fst67 | --cyclo] [-code <code FM>] [-k <k>] [-choice_gg <choice>] [-D <D>] [-e0 <e0>] [-a <auri_a>] [-p <min_pnbits> <max_pnbits> | -r <min_rnbits> <max_rnbits>] [-u <u_mod_m>] -w <Hamming weight in binary form or 2-NAF> --find_all_w_up_to --2NAF --valuation <minimal 2-valuation of both r-1 and p-1>]".format(filename_stem))
i=1
cmd_options = ["--kss", "--gg", "--bls", "--bn", "--auri", "--fm", "--fst62", "--fst63", "--fst64", "--fst66", "--fst67", "--cyclo", "-code", "-k", "-choice_gg", "-D", "-e0", "-a", "-p", "-r", "-u", "-w", "--find_all_w_up_to", "--2NAF", "--valuation"]
...
if not check_pnbits and not check_rnbits and curve == KSS:
    if k == 8:
        ...
        length_r_max = 512
        u_hw = 5
elif not check_pnbits and not check_rnbits and curve == GG:
    if k == 20:
        check_pnbits = False ; check_rnbits = True
        length_r_min = 380
        length_r_max = 384
...
if curve == Aurifeuillean:
    ...
    m, u_m, cofactor_r, twx, g2cx, g2twx, polys_cofact_twists, label_factors, small_cofactors = curve_path.poly_cofactor_twist_g1_g2(k, D, choice_gg)
else:
...
if curve == BLS or curve == BN or curve == KSS or curve == GG:
...
if not check_size_only:
    ...
    if curve == Aurifeuillean:
        ...
        filename += "_D{}_l{}_e0{}".format(D, l, exp_tr)
            ...
            if not bad_param:
                ...
                if D not in [1, 3, 4]:
                    ...
                    if curve == Aurifeuillean:
                        ...
                        E = curve(k=k, u=u, D=D, a=a, b=b, choice_gg=choice_gg)
                    else:
                        ...
                        try:
                            if D == 3:
                                if curve == FotiadisMartindale:
                                    ...
                                    E = curve(k=k, u=u, D=D, l=l, e0=e0, b=ab)
                                elif curve == GG:
                                    E = curve(k=k, u=u, b=ab, D=D, choice_gg=choice_gg)
                                else:
                                ...
                                if curve == FotiadisMartindale:
                                    ...
                                    E = curve(k=k, u=u, D=D, l=l, e0=e0, a=ab)
                                elif curve == GG:
                                    E = curve(k=k, u=u, a=ab, choice_gg=choice_gg)
                                else:
                            ...
                            try:
                                if D == 3:
                                    ...
                                    if curve == FotiadisMartindale:
                                        ...
                                        E = curve(k=k, u=u, a=-ab, D=D, choice_gg=choice_gg)
                                    else:
                                        E = curve(k=k,u=u,a=-ab)
                                ok=True
                                ab = -ab
                ...
                if curve == BLS and k in [12, 24]:
                    ...
                    stnfs = round(stnfs)
                    ctnfs = round(ctnfs)
                    str_res = "    {{\'u\':{: #x}, \'u_mod_{}\':{}, \'b\':{:2d}, \'pnbits\':{}, \'rnbits\':{}, \'cost_S\':{}, \'deg_h_S\':{}, \'cost_C\':{}, \'deg_h_C\':{}, \'label\':\"{} {} {}\"}},".format(u, k_div_d, u_mod_e, ab, p.nbits(), r.nbits(), stnfs, dh_S, ctnfs, dh_C, str_u, str_w, Hw_)
                else:
                    if D not in [1, 3, 4]:
                        str_res = "    {{\'u\':{: #x}, \'u_mod_{}\':{}, \'a\':{:2d}, \'b\':{:2d}, \'pnbits\':{}, \'rnbits\':{}, \'cost_S\':None, \'deg_h_S\':None, \'cost_C\':None, \'deg_h_C\':None, \'label\':\"{} {} {}\"}},".format(u, k_div_d, u_mod_e, a, b, p.nbits(), r.nbits(), str_u, str_w, Hw_)
                    else:
                        if D == 3:
                            str_ab = "b"
                        elif D==1 or D==4:
                            str_ab = "a"
                        str_res = "    {{\'u\':{: #x}, \'u_mod_{}\':{}, \'{}\':{:2d}, \'pnbits\':{}, \'rnbits\':{}, \'cost_S\':None, \'deg_h_S\':None, \'cost_C\':None, \'deg_h_C\':None, \'label\':\"{} {} {}\"}},".format(u, k_div_d, u_mod_e, str_ab, ab, p.nbits(), r.nbits(), str_u, str_w, Hw_)
                print(str_res)
                ofile.write(str_res+"\n")
                ofile.flush()
