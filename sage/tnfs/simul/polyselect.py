...
from tnfs.poly_h.tab_h_6_1_aut import tab_h_6_1
from tnfs.poly_h.tab_h_6_2_aut import tab_h_6_2
...
from tnfs.poly_h.tab_h_15_1_sparse_3_5 import tab_h_15_1_sparse_3_5
...
from tnfs.poly_h.tab_h_21_1_3_zeta_10e4 import tab_h_21_1_3
from tnfs.poly_h.tab_h_21_1_5_zeta_10e4 import tab_h_21_1_5
from tnfs.poly_h.tab_h_22_1_3_zeta_10e4 import tab_h_22_1_3
from tnfs.poly_h.tab_h_22_1_5_zeta_10e4 import tab_h_22_1_5
from tnfs.poly_h.tab_h_24_1_sparse_3_5_prec_10e4_min_09 import tab_h_24_1_sparse_3_5
from tnfs.poly_h.tab_h_27_1_3_zeta_10e4 import tab_h_27_1_3
from tnfs.poly_h.tab_h_27_1_5_zeta_10e4_09_partial import tab_h_27_1_5
from tnfs.poly_h.tab_h_28_1_3_zeta_10e4 import tab_h_28_1_3
from tnfs.poly_h.tab_h_28_1_5_zeta_10e4_09 import tab_h_28_1_5
...
tab_precomputed_h = {2:tab_h_2_1+tab_h_2_2+tab_h_2_3+tab_h_2_4+tab_h_2_5,
                     ...
                     7:tab_h_7_1[:70],# 229 polynomials
                     8:tab_h_8_1[:80],
                     9:tab_h_9_1[:90],
                     10:tab_h_10_1_sparse_3_7[:100],  #  730 polynomials
                     11:tab_h_11_1_sparse_3_7[:110],  # 1362 polynomials
                     12:tab_h_12_1_sparse_3_6[:120],  #  602 polynomials
                     13:tab_h_13_1_sparse_3_6[:130],  #  761 polynomials
                     14:tab_h_14_1_sparse_3_6[:140],  #  979 polynomials
                     15:tab_h_15_1_sparse_3_5[:150],  # 1366 polynomials
                     16:tab_h_16_1_sparse_2_5[:160],
                     18:tab_h_18_1[:180], # 1603 polynomials
                     20:tab_h_20_1_3+tab_h_20_1_5[:200],
                     21:tab_h_21_1_3+tab_h_21_1_5[:210],
                     22:tab_h_22_1_3+tab_h_22_1_5[:220],
                     24:tab_h_24_1_sparse_3_5[:240],
                     27:tab_h_27_1_3+tab_h_27_1_5[:270],
                     28:tab_h_28_1_3+tab_h_28_1_5[:280],
}
...
class Polyselect():
    ...
    def compute_h(self, deg_h=None, tab_h=None):
        ...
        for deg_h in range_deg_h:
            ...
            self._list_h[deg_h] = [tup for tup in tab_precomp_h[deg_h] if self._Fpz(tup[-1]).is_irreducible() ]
            # the coefficients of h are listed as last item, either (inv_zeta_kh, w, hc) or (inv_zeta_kh, w, aut, hc)
    ...
    def Resultant(self, deg_g, aux0, aux1, h=None, with_y=False, coeff_y=None, mult_y=True, MNT6=False):
        """
        :param deg_g: degree of g
        :param aux0: a list of coefficients (e.g. f given by JouxLercier or Conjugation)
        :param aux1: a list of coefficients (e.g. g given by JouxLercier or Conjugation)
        :param    h: a list of coefficients
        :param with_y: if f, g should be univariate in x or bivariate in x, y
        :param coeff_y: a pair(numerator, denominator) of coeffs in y
        :param mult_y: multiply of add the coefficient in y to U
        :param MNT6: special case
        """
        ...
        if coeff_y is None:
            ...
            coeff_y_num = ZZy(coeff_y[0])
            coeff_y_den = ZZy(coeff_y[1])
        list_cyclic_g_ty_ = {1: (x-U)*coeff_y_den-coeff_y_num,
                            2: (x**2-U)*coeff_y_den-coeff_y_num,
                            3: x**3*coeff_y_den - (U*coeff_y_den+coeff_y_num)*x**2 - ((U+3)*coeff_y_den+coeff_y_num)*x - coeff_y_den,
                            4: x**4*coeff_y_den -(U*coeff_y_den+coeff_y_num)*x**3 -6*coeff_y_den*x**2 + (U*coeff_y_den+coeff_y_num)*x + coeff_y_den,
                             6: x**6*coeff_y_den -2*(U*coeff_y_den+coeff_y_num)*x**5 - 5*((U+3)*coeff_y_den+coeff_y_num)*x**4 -20*coeff_y_den*x**3 +5*(U*coeff_y_den+coeff_y_num)*x**2 + 2*((U+3)*coeff_y_den+coeff_y_num)*x + coeff_y_den}
        list_cyclic_g_ty = {1: x*coeff_y_den-U*coeff_y_num,
                            2: x**2*coeff_y_den-U*coeff_y_num,
                            3: x**3*coeff_y_den - (U*coeff_y_num)*x**2 - (U*coeff_y_num+3*coeff_y_den)*x - coeff_y_den,
                            4: x**4*coeff_y_den -(U*coeff_y_num)*x**3 -6*coeff_y_den*x**2 + (U*coeff_y_num)*x + coeff_y_den,
                            6: x**6*coeff_y_den -2*(U*coeff_y_num)*x**5 - 5*(U*coeff_y_num+3*coeff_y_den)*x**4 -20*coeff_y_den*x**3 +5*(U*coeff_y_num)*x**2 + 2*(U*coeff_y_num+3*coeff_y_den)*x + coeff_y_den}
        if not with_y:
            if deg_g in list_cyclic_g_t:
            ...
            if mult_y and deg_g in list_cyclic_g_ty:
                ...
                # no cyclic solution
                gt = (x**deg_g + x + U + 1)*coeff_y_den + coeff_y_num
    ...
    def NFS_Conjugation(self, deg_g, sieving_dim=2, max_coeff=4, monic=False, compute_alpha=True, verbose=False, B0_alpha=800, B1_alpha=2000):
