...
def test_cocks_pinch_k8_gmt():
    ...
    # Sarkar-Singh
    # todo
    # test_finite_field_tnfs(p, r, k, cost=150, samples=10000, sarkarsingh=True, all_deg_h=[2], max_coeff=1, deg_f=5, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)
    # Joux-Lercier, check what's happening when gcd(deg(h), k/deg(h)) > 1
    # todo
    test_finite_field_tnfs(p, r, k, cost=148, samples=100000, jouxlercier=True, all_deg_h=[2], max_coeff=1, deg_f=5, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)
    test_finite_field_tnfs(p, r, k, cost=146, samples=100000, jouxlercier=True, all_deg_h=[2], max_coeff=1, deg_f=6, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)

    test_finite_field_tnfs(p, r, k, cost=176, samples=100000, jouxlercier=True, all_deg_h=[4], max_coeff=1, deg_f=3, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)
    test_finite_field_tnfs(p, r, k, cost=159, samples=100000, jouxlercier=True, all_deg_h=[4], max_coeff=1, deg_f=4, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)

    test_finite_field_tnfs(p, r, k, cost=174, samples=100000, jouxlercier=True, all_deg_h=[8], max_coeff=1, deg_f=3, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)
    test_finite_field_tnfs(p, r, k, cost=157, samples=100000, jouxlercier=True, all_deg_h=[8], max_coeff=1, deg_f=4, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)
    test_finite_field_tnfs(p, r, k, cost=149, samples=100000, jouxlercier=True, all_deg_h=[8], max_coeff=1, deg_f=5, B0_alpha=800, B1_alpha=1200, compute_alpha=True, alpha_test_principal=False)
